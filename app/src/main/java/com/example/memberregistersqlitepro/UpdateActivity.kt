...
class UpdateActivity : AppCompatActivity() {
    val binding: ActivityUpdateBinding by lazy { ActivityUpdateBinding.inflate(layoutInflater) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSearchId.setOnClickListener {
            ...
            if (id.isEmpty()) {
                Toast.makeText(this, "수정할 id 입력 바람", Toast.LENGTH_SHORT).show()
            } else {
                ...
                if (member != null) {
                    ...
                    Toast.makeText(this, "수정할 데이터 정보를 가져오지 못함", Toast.LENGTH_SHORT).show()
                }
            }
        }
